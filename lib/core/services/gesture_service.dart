...
class GestureService {
  ...
  Future<void> _initialize() async {
    try {
      ...
      final sensitivityIndex =
          prefs.getInt(_keySensitivity) ?? GestureSensitivity.medium.index;
  ...
  Future<void> setSensitivity(GestureSensitivity sensitivity) async {
    ...
    AppLogger.logUserAction(
        'gesture_sensitivity_changed', {'sensitivity': sensitivity.name});
  }
  ...
  Future<void> setLeftHandedMode(bool leftHanded) async {
    ...
    AppLogger.logUserAction(
        'left_handed_mode_changed', {'leftHanded': leftHanded});
  }

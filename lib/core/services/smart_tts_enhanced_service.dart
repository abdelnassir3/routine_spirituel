...
class SmartTtsEnhancedService {
  ...
  SmartTtsEnhancedService(this._audioPlayer,
      {AudioTtsService? classicTtsService})
  ...
  Future<void> playTextHybrid(
    ...
    try {
      ...
      debugPrint(
          '📝 Texte: ${text.substring(0, text.length.clamp(0, 100))}...');
  ...
  Future<void> _fallbackToClassicTts(
    ...
    try {
      ...
      if (_classicTtsService != null) {
        debugPrint(
            '💬 Utilisation du SmartTtsService classique avec voix: $voice');
        ...
        debugPrint(
            '⚠️ Aucun service TTS classique disponible pour le fallback');
      }
    } catch (e) {

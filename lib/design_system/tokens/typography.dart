...
class AdvancedTypography {
  ...
  static const String fontFamilyMono =
      'JetBrains Mono'; // Pour les codes/références
  ...
  static TextTheme generateTextTheme(
    ...
    return TextTheme(
      ...
      displayLarge:
          _createTextStyle(_displayScale.large, onSurface, fontFamilyDisplay),
      displayMedium:
          _createTextStyle(_displayScale.medium, onSurface, fontFamilyDisplay),
      displaySmall:
          _createTextStyle(_displayScale.small, onSurface, fontFamilyDisplay),

      // Headline styles - For section headers
      headlineLarge:
          _createTextStyle(_headlineScale.large, onSurface, fontFamilyFR),
      headlineMedium:
          _createTextStyle(_headlineScale.medium, onSurface, fontFamilyFR),
      headlineSmall:
          _createTextStyle(_headlineScale.small, onSurface, fontFamilyFR),

      // Title styles - For component titles
      titleLarge: _createTextStyle(_titleScale.large, onSurface, fontFamilyFR),
      titleMedium:
          _createTextStyle(_titleScale.medium, onSurface, fontFamilyFR),
      ...
      bodySmall:
          _createTextStyle(_bodyScale.small, onSurfaceVariant, fontFamilyFR),

      // Label styles - For buttons and UI elements
      labelLarge: _createTextStyle(_labelScale.large, onSurface, fontFamilyFR),
      labelMedium:
          _createTextStyle(_labelScale.medium, onSurface, fontFamilyFR),
      labelSmall:
          _createTextStyle(_labelScale.small, onSurfaceVariant, fontFamilyFR),
    );
  }
  ...
  static TextStyle _createTextStyle(
    ...
    return TextStyle(
      ...
      fontFamilyFallback:
          primaryFont == fontFamilyFR ? fontFamilyAR : [fontFamilyFR],
...
extension TextStyleExtensions on TextStyle {
  ...
  TextStyle get arabic => copyWith(
        fontFamily: 'NotoNaskhArabic',
        fontFamilyFallback: const ['Amiri', 'Inter'],

...
void main() {
  group('RoutineCompletionStatus', () {
    ...
    test('calcule le statut monthly completed correctement', () {
      ...
      final session = SessionRow(
        ...
        endedAt:
            startOfMonth.add(const Duration(days: 5, hours: 10, minutes: 30)),
        state: 'completed',
        snapshotRef: null,
      );
  ...
  group('RoutineCompletionStatusExtension', () {
    test('retourne les bonnes icônes', () {
      expect(
          RoutineCompletionStatus.completed.iconName, equals('check_circle'));
    ...
    test('retourne les bonnes descriptions', () {
      expect(
          RoutineCompletionStatus.completed.description, equals('Accomplie'));

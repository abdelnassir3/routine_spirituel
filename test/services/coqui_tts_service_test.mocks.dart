...
// in spiritual_routines/test/services/coqui_tts_service_test.dart.
...
/// A class which mocks [SecureTtsCacheService].
///
/// See the documentation for Mockito's code generation for more information.
class MockSecureTtsCacheService extends _i1.Mock
    implements _i11.SecureTtsCacheService {
  MockSecureTtsCacheService() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i9.Future<String> generateKey({
  ...
  @override
  _i9.Future<_i8.Directory> cacheDir() => (super.noSuchMethod(
        Invocation.method(
          #cacheDir,
          [],
        ),
        returnValue: _i9.Future<_i8.Directory>.value(_FakeDirectory_6(
          this,
          Invocation.method(
            #cacheDir,
            [],
      ...
      ) as _i9.Future<_i8.Directory>);

  @override
  _i9.Future<bool> exists(String? key) => (super.noSuchMethod(
        Invocation.method(
          #exists,
          [key],
        ),
  ...
  @override
  _i9.Future<String?> getPath(String? key) => (super.noSuchMethod(
        Invocation.method(
          #getPath,
          [key],
        ),

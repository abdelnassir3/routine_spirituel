...
void main() {
  group('DesktopInteractiveWidget Tests', () {
    testWidgets('Shows hover effect on mouse enter', (tester) async {
      ...
      expect((hoveredContainer.decoration as BoxDecoration).color, isNot(Colors.transparent));
    });
  ...
  group('SpiritualKeyboardShortcuts', () {
    test('Shortcuts are defined correctly', () {
      ...
      expect(SpiritualKeyboardShortcuts.home, 
        equals(const SingleActivator(LogicalKeyboardKey.keyH, control: true)));
      expect(SpiritualKeyboardShortcuts.routines,
        equals(const SingleActivator(LogicalKeyboardKey.keyR, control: true)));
      expect(SpiritualKeyboardShortcuts.reader,
        equals(const SingleActivator(LogicalKeyboardKey.keyL, control: true)));
      expect(SpiritualKeyboardShortcuts.settings,
        equals(const SingleActivator(LogicalKeyboardKey.keyS, control: true)));
      
      // Action shortcuts
      expect(SpiritualKeyboardShortcuts.newRoutine,
        equals(const SingleActivator(LogicalKeyboardKey.keyN, control: true)));
      expect(SpiritualKeyboardShortcuts.search,
        equals(const SingleActivator(LogicalKeyboardKey.keyF, control: true)));
      ...
      expect(SpiritualKeyboardShortcuts.reset,
        equals(const SingleActivator(LogicalKeyboardKey.keyR, control: true, shift: true)));
    });
  });
}
...
void main() async {
  ...
  try {
    ...
    print('  - quran_combined.json: ${await quranCombined.exists() ? "✅ Existe" : "❌ Manquant"}');
    print('  - quran_full.json: ${await quranFull.exists() ? "✅ Existe" : "❌ Manquant"}');
    ...
    if (await quranFull.exists()) {
      ...
      final fatiha1 = fullData.firstWhere((v) => v['surah'] == 1 && v['ayah'] == 1, orElse: () => null);
      final bakara1 = fullData.firstWhere((v) => v['surah'] == 2 && v['ayah'] == 1, orElse: () => null);
      
      print('📖 Vérification de versets clés:');
      print('  - Al-Fatiha 1:1: ${fatiha1 != null ? "✅ Trouvé" : "❌ Manquant"}');
      print('  - Al-Bakara 2:1: ${bakara1 != null ? "✅ Trouvé" : "❌ Manquant"}');
    ...
    if (await quranCombined.exists()) {
      ...
      print('  - Nombre de versets dans quran_combined.json: ${combinedData.length}');
  ...
  print('\n💡 Changement appliqué:');
  print('   QuranContentDetector charge maintenant quran_full.json au lieu de quran_combined.json');

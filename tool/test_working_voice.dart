...
Future<void> testValidVoice(
    String endpoint, String apiKey, String voice) async {
  print('\n🎤 Test voix: $voice');
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      try {
        ...
        print(
            '  ⚠️ Réponse non-JSON (peut-être binary): ${responseBody.length} chars');
        if (responseBody.startsWith('\xff\xfb') ||
